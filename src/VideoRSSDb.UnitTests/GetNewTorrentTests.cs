...
namespace VideoRSSDb.UnitTest
{
    ...
    public class GetNewTorrentTests : SqlDatabaseTestClass
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            should_raise_error_with_no_table_entered_TestAction.Conditions.Add(scalarValueCondition1);
            ...
            scalarValueCondition1.ExpectedValue = "Operand type clash: NULL is incompatible with torrent_id_table_type";
            ...
            // 
            should_return_id_of_entered_torrent_that_does_not_exist_TestAction.Conditions.Add(scalarValueCondition2);
            ...
            scalarValueCondition2.ExpectedValue = "test_1112344";
